defmodule AMath.Web.PlayerPresence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule AMath.MyChannel do
        use AMath.Web, :channel
        alias AMath.PlayerPresence
  ...
  In the example above, `PlayerPresence.track` is used to register this
  ...
  """
  use Phoenix.Presence, otp_app: :a_math,
